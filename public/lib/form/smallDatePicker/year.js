...
var yearButton = {
    ...
    implementation: function(public, protected, private){
        ...
        public.use({Height: 24, Width: 15, FontSize: 12, BorderRadius: 8, FontWeight: "bold", Align: "center"});
...
var year= {
    ...
    implementation: function(public, protected, private){
        ...
        var title = New(UI.Text, { RelativeRect : { left: 5, top:5, bottom: 5, right: 5}, FontSize: 12, Text : "2014", FontWeight: "bold", Align: "center",   Text : "2014", Align: "center" });
        public.add(title);
