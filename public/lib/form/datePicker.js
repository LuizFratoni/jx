...
var dateCell = {
    ...
    implementation: function(public, protected, private){
        public.use({Width: 40, Height: 25, BorderRadius: 10, Align: "center", FontColor : "#909090", Text : "00"} )
        ...
        public.setFeriado = function(b){
            if (b == true) public.setFontColor("#aa4500");
        }
...
var dateWeek = {
    ...
    implementation: function(public, protected, private){
        public.use({Width: 40, Height: 31, Align: "center", FontColor : "#303030", Text : "00"} )
...
var datePicker = {
    ...
    implementation: function(public, protected, private){
        ...
        var month = New("form/datePicker/month", {Left: 0, Top:0, Width: 200, Height: 30});
        
        var year = New("form/datePicker/year", {Left: 200, Top: 0,Width: 80, Height: 30});
        ...
        for (var i = 0; i < 42; i++ ){
            if ( i % 7 == 0){
                 row   = New(UI.Container, {Orientation: "horizontal", Height: 31});
                 content.add(row);
            }
        ...
        protected.prepareCalendar = function(month, year){
            ...
            protected.yearNumber = year;
             ...
             for (var i = 1; i <= monthLen; i++){
                storedCells[i-1] = cells[i+fillCell-1].use({Enabled : true, Text : i});
             }
             ...
             if (protected.checkFeriados != null){

                protected.monthCell = storedCells;
                //Preenche datas do Mes seguinte
   
                Autosig.post("rh/relogioPonto/feriados", { mes : month+1, ano : year}, function(error, data){
                   data.forEach(function(f){
                       protected.monthCell[f.dia-1].setFeriado(true);
                   });
                });
             }
        }

        public.setCheckFeriados = function(){
            protected.checkFeriados = true;
        }
