...
var monthButton = {
    ...
    implementation: function(public, protected, private){
        ...
        public.use({Height: 24, Width: 30, FontSize: 14, BorderRadius: 8, FontWeight: "bold", Align: "center"});
...
var month = {
    ...
    implementation: function(public, protected, private){
        ...
        var title = New(UI.Text, { RelativeRect : { left: 5, top:5, bottom: 5, right: 5}, FontSize: 14, FontColor : "#909090", FontWeight:"bold",   Text : "Janeiro", Align: "center" });
        public.add(title);
