...
var text = {
    ...
    implementation: function(public, protected, private){
        public.use({  Border : { width : 1, color : "#cccccc"}, PaddingLeft: 4, BackgroundColor : "transparent"})
        ...
        protected.element.onblur = function(l){
            if (protected.fieldType == "money"){
                ...
                if (protected.value == null || isNaN(protected.value == true))
                    protected.value = 0;
            } else {
                protected.value = protected.element.value;
            }
       ...
       /* public.onExitFocus(function(){
        ...
        public.setStyle = function(style){
            ...
            if (style == "uppercase"){
                protected.element.style.textTransform = "uppercase";
